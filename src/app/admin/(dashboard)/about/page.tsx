      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-[var(--color-navy)] rounded-2xl p-6 border border-white/5">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-lg font-display text-white">About Page Content</h2>
          </div>
          
          <div className="space-y-4">
            <div className="bg-[var(--color-ink-dark)] border border-white/5 rounded-xl p-6">
                <h3 className="text-[10px] font-display uppercase tracking-widest text-[var(--color-grey)] mb-4">Core Values / Studio Philosophy</h3>
                <p className="text-sm font-body text-white mb-4">Edit the text blocks and images associated with the studio's philosophy section.</p>
