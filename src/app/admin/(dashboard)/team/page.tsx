        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 relative z-10">
          <div>
            ...
            <p className="text-sm font-body text-[var(--color-grey)] max-w-2xl">
              Manage studio personnel, architects, and access permissions.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-[var(--color-navy)] rounded-2xl p-6 border border-white/5">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-lg font-display text-white">Team Roster Database</h2>
          </div>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {/* Mock Team List */}
            {[
              { name: "Elena Vance", role: "Lead Architect", img: "/images/general/Nour2.webp" },
              { name: "Marcus Thorne", role: "Principal Lighting Designer", img: "/images/general/Nour2.webp" },
              { name: "Sarah Chen", role: "Sustainability Director", img: "/images/general/Nour2.webp" }
            ].map((member, i) => (
