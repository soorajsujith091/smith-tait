...
export const projects: Project[] = [
  {
    ...
    client: "Binghatti",
    scope: "Interior, Facade and Landscape",
    year: 2025,
    heroImage: "/images/projects/SKYBLADE/skyblade-01.png",
    gallery: [
      "/images/projects/SKYBLADE/skyblade-01.png",
      "/images/projects/SKYBLADE/skyblade-02.png",
      "/images/projects/SKYBLADE/skyblade-03.png",
      "/images/projects/SKYBLADE/skyblade-04.png",
      "/images/projects/SKYBLADE/skyblade-05.png",
      "/images/projects/SKYBLADE/skyblade-06.png",
    ],
    overview: "A striking residential tower currently ongoing, featuring comprehensive interior, facade, and landscape lighting design.",
    designConcept: "Creating a cohesive nocturnal identity for this iconic tower through integrated facade illumination and refined interior lighting.",
    credits: [
      { role: "Lighting Design", name: "Smith Tait" },
      { role: "Consultant", name: "Silverstone" },
      { role: "Client", name: "Binghatti" },
    ],
  },
  {
    slug: "canal-crown",
    name: "Canal Crown 01 & 02",
    location: "Dubai",
    category: "Residential",
    client: "Damac",
    scope: "Interior, Facade & Landscape",
    year: 2025,
    heroImage: "/images/projects/CANAL CROWN 01 & 02/canal-crown-01.png",
    gallery: [
      "/images/projects/CANAL CROWN 01 & 02/canal-crown-01.png",
      "/images/projects/CANAL CROWN 01 & 02/canal-crown-02.png",
    ],
    overview: "Twin residential towers situated along the canal, currently in the construction phase, featuring extensive interior, facade, and landscape lighting scope.",
    designConcept: "Emphasizing the twin towers' architectural curves and waterfront location with dynamic facade lighting and elegant interior ambiance.",
    credits: [
      { role: "Lighting Design", name: "Smith Tait" },
      { role: "Consultant", name: "K&A" },
      { role: "Client", name: "Damac" },
    ],
  },
  {
    slug: "coj",
    ...
    scope: "Interior, Facade & Landscape",
    year: 2024,
    heroImage: "/images/projects/COJ/coj-01.png",
    gallery: [
      "/images/projects/COJ/coj-01.png",
      "/images/projects/COJ/coj-02.png",
      "/images/projects/COJ/coj-03.png",
      "/images/projects/COJ/coj-04.png",
    ],
    overview: "An institutional project for the City of Johannesburg featuring complete interior, facade, and landscape lighting.",
    designConcept: "Delivering a civic-scaled lighting strategy that balances security, public accessibility, and architectural grandeur.",
    credits: [
      { role: "Lighting Design", name: "Smith Tait" },
      { role: "Consultant", name: "Studio Mass" },
      { role: "Client", name: "City of Johannesburg" },
    ],
  },
  {
    slug: "private-villa-omniyat",
    name: "Private Villa",
    location: "Dubai",
    category: "Residential",
    client: "Omniyat",
    scope: "Facade and Landscape",
    year: 2024,
    heroImage: "/images/projects/PRIVATE VILL A/private-villa-01.png",
    gallery: [
      "/images/projects/PRIVATE VILL A/private-villa-01.png",
      "/images/projects/PRIVATE VILL A/private-villa-02.png",
      "/images/projects/PRIVATE VILL A/private-villa-03.png",
      "/images/projects/PRIVATE VILL A/private-villa-04.png",
      "/images/projects/PRIVATE VILL A/private-villa-05.png",
      "/images/projects/PRIVATE VILL A/private-villa-06.png",
      "/images/projects/PRIVATE VILL A/private-villa-07.png",
    ],
    overview: "A luxury private villa featuring specialized facade and landscape lighting design to enhance its architectural features and outdoor living spaces.",
    designConcept: "Soft, integrated landscape lighting combined with precise facade accents to create a tranquil residential oasis.",
    credits: [
      { role: "Lighting Design", name: "Smith Tait" },
      { role: "Consultant", name: "Omniyat" },
      { role: "Client", name: "Omniyat" },
    ],
  },
  {
